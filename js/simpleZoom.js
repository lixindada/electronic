 ...
 * @html5+css3+jQuery+Responsive: http://www.imsole.net/html5/
*/
;(function($){
  $.fn.simpleZoom = function(options){
		...
		return this.each(function(){
			...
			var mark_css = {position:"absolute", top:0, left:0, width:markSize[0]+"px", height:markSize[1]+"px", backgroundColor:"#000", opacity:.3, filter:"alpha(opacity=30)",  display:"none", cursor:"crosshair"};
